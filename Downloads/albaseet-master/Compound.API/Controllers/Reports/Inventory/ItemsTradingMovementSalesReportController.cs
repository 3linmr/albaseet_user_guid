...
namespace Compound.API.Controllers.Reports.Inventory
{
	...
	[Authorize]
	[ApiController]
	public class ItemsTradingMovementSalesReportController : Controller // ﬁ—Ì— «·Õ—ﬂ… «· Ã«—Ì… ··√’‰«› »Ì⁄
	{
		private readonly IItemsTradingMovementReportService _itemTradingMovmentReportService;
		private readonly IMenuService _menuService;

		public ItemsTradingMovementSalesReportController(IItemsTradingMovementReportService itemTradingMovmentReportService, IMenuService menuService)
		{
		...
		[HttpGet]
		[Route("ReadItemsTradingMovementSalesReport")]
