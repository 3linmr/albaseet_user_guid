...
var compoundAPI = configuration.GetValue<string>("Application:CompoundAPI");
...
//AutoMapper
var mappingConfig = new MapperConfiguration(mc => { mc.AddProfile(new AccountingMappingProfile()); });
...
if (allowSwagger)
{
	...
	app.UseSwaggerUI(c =>
	{
		c.SwaggerEndpoint($"{compoundAPI}/swagger/v1/swagger.json", "Compound APIs");
