...
{
    public class StockOutReturnDto
    {
        public StockOutReturnHeaderDto? StockOutReturnHeader { get; set; }
        public List<StockOutReturnDetailDto> StockOutReturnDetails { get; set; } = new List<StockOutReturnDetailDto>();
        public List<MenuNoteDto>? MenuNotes { get; set; } = new List<MenuNoteDto>();
    }

    public class StockOutReturnHeaderDto
    {
        ...
        public string? StockOutFullCode { get; set; }
        public string? StockOutDocumentReference { get; set; }
        public int? StockOutProformaInvoiceHeaderId { get; set; }
        public string? StockOutProformaInvoiceFullCode { get; set; }
        public string? StockOutProformaInvoiceDocumentReference { get; set; }
        public int? StockOutSalesInvoiceHeaderId { get; set; }
        public string? StockOutSalesInvoiceFullCode { get; set; }
        public string? StockOutSalesInvoiceDocumentReference { get; set; }
    ...
    public class StockOutReturnDetailTaxDto
    {
        public int StockOutReturnDetailTaxId { get; set; }
    ...
    public class StockOutReturnDetailDto
    {
        ...
        public decimal StockOutBonusQuantity { get; set; }
        ...
        public List<StockOutReturnDetailTaxDto> StockOutReturnDetailTaxes { get; set; } = new List<StockOutReturnDetailTaxDto>();
    }

    public class StockDisbursedReturnedDto
    {
        public int ItemId { get; set; }
        public int ItemPackageId { get; set; }
        public string? BatchNumber { get; set; }
    ...
    public class StockOutReturnFromParentDto
    {
		public byte StockTypeId { get; set; }
        public int? StockOutHeaderId {get;set;}
        public string? StockOutFullCode {get;set;}
