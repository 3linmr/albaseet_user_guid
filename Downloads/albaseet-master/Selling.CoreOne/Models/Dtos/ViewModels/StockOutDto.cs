...
{
    public class StockOutWithResponseDto
    {
        public required StockOutDto StockOut { get; set; }
        public required ResponseDto Result { get; set; }
    }

    public class StockOutDetailsWithResponseDto
    {
		public required List<StockOutDetailDto> StockOutDetails { get; set; }
		public required ResponseDto Result { get; set; }
	}

	public struct StockOutDetailsAndListofIncompleteItems
	{
		public required List<StockOutDetailDto> StockOutDetails;
		public required List<IncompleteItemDto> incompleteItemIds;
	}

	public class StockOutDto
    {
        public StockOutHeaderDto? StockOutHeader { get; set; }
        public List<StockOutDetailDto> StockOutDetails { get; set; } = new List<StockOutDetailDto>();
    ...
    public class StockOutDetailTaxDto
    {
    ...
    public class StockOutDetailDto
    {
        ...
        public decimal ProformaInvoiceQuantity { get; set; }
        public decimal ProformaInvoiceBonusQuantity { get; set; }
        ...
        public List<StockOutDetailTaxDto> StockOutDetailTaxes { get; set; } = new List<StockOutDetailTaxDto>();
    }

    public class StockDisbursedFromProformaInvoiceDto
    {
        public int ItemId { get; set; }
        public int ItemPackageId { get; set; }
        public string? BatchNumber { get; set; }
        ...
        public decimal SellingPrice { get; set; }
        public decimal ItemDiscountPercent { get; set; }
        public decimal QuantityDisbursed { get; set; }
        public decimal BonusQuantityDisbursed { get; set; }
    }

    public class StockDisbursedFromSalesInvoiceDto
    {
        public int ItemId { get; set; }
        public int ItemPackageId { get; set; }
        public string? BatchNumber { get; set; }
	...
	public class StockOutParentDto
	{
		public byte StockTypeId { get; set; }
		public int ParentHeaderId { get; set; }
		public string? ParentFullCode { get; set; }
		public string? ParentDocumentReference { get; set; }
		public int ClientId { get; set; }
        public int ClientCode { get; set; }
		public string? ClientName { get; set; }
        public int? SellerId { get; set; }
    ...
    public class ReservationStoreAndParentStoreCurrentBalancesDto
    {
        public List<ItemCurrentBalanceDto> ReservationStoreCurrentBalances { get; set; } = [];
        public List<ItemCurrentBalanceDto> ParentStoreCurrentBalances { get; set; } = [];
    }
}
