...
{
    public class ClientQuotationDto
    {
        public ClientQuotationHeaderDto? ClientQuotationHeader { get; set; }
        public List<ClientQuotationDetailDto> ClientQuotationDetails { get; set; } = new List<ClientQuotationDetailDto>();
        public List<MenuNoteDto> MenuNotes { get; set; } = new List<MenuNoteDto>();
    }

    public class ClientQuotationHeaderDto
    {
    ...
    public class ClientQuotationDetailTaxDto
    {
        public int ClientQuotationDetailTaxId { get; set; }
    ...
    public class ClientQuotationDetailDto
    {
        public int ClientQuotationDetailId { get; set; }
        public int ClientQuotationHeaderId { get; set; }
        ...
        public List<ClientQuotationDetailTaxDto> ClientQuotationDetailTaxes { get; set; } = new List<ClientQuotationDetailTaxDto>();
    }
}
