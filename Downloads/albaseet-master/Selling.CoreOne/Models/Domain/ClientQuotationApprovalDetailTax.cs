...
{
	public class ClientQuotationApprovalDetailTax : BaseObject
	{
		[Column(Order = 1)]
		...
		[ForeignKey(nameof(ClientQuotationApprovalDetailId))]
		public ClientQuotationApprovalDetail? ClientQuotationApprovalDetail { get; set; }
