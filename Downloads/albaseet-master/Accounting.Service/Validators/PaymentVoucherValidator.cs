...
{
    internal class PaymentVoucherValidator : AbstractValidator<PaymentVoucherHeader>
    {
        public PaymentVoucherValidator(IStringLocalizer<PaymentVoucherHeaderService> localizer)
        {
            RuleFor(x => x.PaymentVoucherHeaderId)
                .NotEmpty()
                .NotNull()
                .NotEqual(0);

            RuleFor(x => x.PaymentVoucherCode)
                .NotEmpty()
                .NotNull()
                .GreaterThan(0);
