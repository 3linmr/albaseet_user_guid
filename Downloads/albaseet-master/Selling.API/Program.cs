...
using Sales.Service.Extensions;
...
var salesAPI = configuration.GetValue<string>("Application:SalesAPI");
...
//AutoMapper
var mappingConfig = new MapperConfiguration(mc => { mc.AddProfile(new SalesMappingProfile()); });
...
if (allowSwagger)
{
	...
	app.UseSwaggerUI(c =>
	{
		c.SwaggerEndpoint($"{salesAPI}/swagger/v1/swagger.json", "Sales APIs");
