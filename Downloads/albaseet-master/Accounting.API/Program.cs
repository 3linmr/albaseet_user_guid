...
var accountingAPI = configuration.GetValue<string>("Application:AccountingAPI");
...
if (allowSwagger)
{
	...
	app.UseSwaggerUI(c =>
	{
		c.SwaggerEndpoint($"{accountingAPI}/swagger/v1/swagger.json", "Accounting APIs");
		...
		c.DocumentTitle = "Accounting APIs";
	});
}
