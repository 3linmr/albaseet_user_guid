...
{
    public class SupplierDebitMemoValidator: AbstractValidator<SupplierDebitMemo>
    {
        public SupplierDebitMemoValidator(IStringLocalizer<SupplierDebitMemoService> localizer)
        {
            RuleFor(x => x.StoreId)
                .NotEmpty()
                .NotNull();
