...
{
	public class SupplierQuotationDetailTax : BaseObject
	{
		[Column(Order = 1)]
		...
		[ForeignKey(nameof(SupplierQuotationDetailId))]
		public SupplierQuotationDetail? SupplierQuotationDetail { get; set; }
