...
{
	public class ProductRequestPriceDetailTax : BaseObject
	{
		[Column(Order = 1)]
		...
		[Column(Order = 5)]
		public int DebitAccountId { get; set; }  //DebitAccount
		...
		[ForeignKey(nameof(ProductRequestPriceDetailId))]
		public ProductRequestPriceDetail? ProductRequestPriceDetail { get; set; }
