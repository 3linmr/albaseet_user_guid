...
{
    public class StockInReturnDto
    {
        public StockInReturnHeaderDto? StockInReturnHeader { get; set; }
        public List<StockInReturnDetailDto> StockInReturnDetails { get; set; } = new List<StockInReturnDetailDto>();
        public List<MenuNoteDto>? MenuNotes { get; set; } = new List<MenuNoteDto>();

    }

    public class StockInReturnHeaderDto
    {
        ...
        public string? StockInFullCode { get; set; }
        public string? StockInDocumentReference { get; set; }
        public int? StockInPurchaseOrderHeaderId { get; set; }
        public string? StockInPurchaseOrderFullCode { get; set; }
        public string? StockInPurchaseOrderDocumentReference { get; set; }
        public int? StockInPurchaseInvoiceHeaderId { get; set; }
        public string? StockInPurchaseInvoiceFullCode { get; set; }
        public string? StockInPurchaseInvoiceDocumentReference { get; set; }
    ...
    public class StockInReturnDetailTaxDto
    {
        public int StockInReturnDetailTaxId { get; set; }
        public int StockInReturnDetailId { get; set; }
    ...
    public class StockInReturnDetailDto
    {
        public int StockInReturnDetailId { get; set; }
        public int StockInReturnHeaderId { get; set; }
        ...
        public decimal StockInBonusQuantity { get; set; }
        ...
        public List<StockInReturnDetailTaxDto> StockInReturnDetailTaxes { get; set; } = new List<StockInReturnDetailTaxDto>();
    }

    public class StockReturnedDto
    {
        public int ItemId { get; set; }
        public int ItemPackageId { get; set; }
        public DateTime? ExpireDate { get; set; }
        ...
        public decimal BonusQuantityReturned { get; set; }
    }
}
