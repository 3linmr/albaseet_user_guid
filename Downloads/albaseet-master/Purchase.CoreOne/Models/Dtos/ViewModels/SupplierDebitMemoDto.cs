...
{
    public class SupplierDebitMemoVm
    {
        public SupplierDebitMemoDto? SupplierDebitMemo { get; set; }
        public JournalDto? Journal { get; set; }
        public List<MenuNoteDto>? MenuNotes { get; set; } = new List<MenuNoteDto>();
    }

    public class SupplierDebitMemoDto
    {
        public int SupplierDebitMemoId { get; set; }
