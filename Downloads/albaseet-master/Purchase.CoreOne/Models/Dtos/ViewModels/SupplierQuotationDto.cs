...
namespace Purchases.CoreOne.Models.Dtos.ViewModels
{
    ...
    {
        public SupplierQuotationHeaderDto? SupplierQuotationHeader { get; set; }
        public List<SupplierQuotationDetailDto> SupplierQuotationDetails { get; set; } = new List<SupplierQuotationDetailDto>();
    ...
    public class SupplierQuotationDetailTaxDto
    {
        public int SupplierQuotationDetailTaxId { get; set; }
        public int SupplierQuotationDetailId { get; set; }
    ...
    public class SupplierQuotationDetailDto
    {
        ...
        public List<SupplierQuotationDetailTaxDto> SupplierQuotationDetailTaxes { get; set; } = new List<SupplierQuotationDetailTaxDto>();
    }
}
