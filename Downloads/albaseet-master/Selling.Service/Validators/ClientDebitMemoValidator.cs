...
{
    public class ClientDebitMemoValidator: AbstractValidator<ClientDebitMemo>
    {
        public ClientDebitMemoValidator(IStringLocalizer<ClientDebitMemoService> localizer)
        {
            RuleFor(x => x.StoreId)
                .NotEmpty()
                .NotNull();
