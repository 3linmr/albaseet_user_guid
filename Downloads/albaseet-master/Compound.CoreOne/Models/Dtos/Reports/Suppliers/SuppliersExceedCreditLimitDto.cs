...
{
    public class SuppliersExceedCreditLimitDto
    {
        public int AccountId { get; set; }
        public string? AccountName { get; set; } // Supplier's account name
        ...
        public string? LastPaymentVoucherFullCode { get; set; } // Last payment receipt number
        public decimal? LastPaymentVoucherValue { get; set; } // Last payment amount
        public decimal CreditLimitValues { get; set; } // Supplier's credit limit
        public decimal Balance { get; set; } // Current balance of the supplier
        ...
        //public string? TaxInfo { get; set; } // Tax-related information for the supplier
