...
{
	public class StockOutFromProformaInvoiceFollowUpReportVm
	{
		public StockOutFromProformaInvoiceFollowUpReportDto? StockOutFromProformaInvoiceFollowUpReportDto { get; set; }
		public StockOutFromProformaInvoiceFollowUpDetailReportDto? StockOutFromProformaInvoiceFollowUpDetailReportDto { get; set; }
	}

    public class StockOutFromProformaInvoiceFollowUpReportDto
    {
    ...
    public class StockOutFromProformaInvoiceFollowUpDetailReportDto
    {
		public int StockOutHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
