...
{
	public class ProductRequestFollowUpReportVm
	{
		public ProductRequestFollowUpReportDto? ProductRequestFollowUpReportDto { get; set; }
		public ProductRequestFollowUpDetailReportDto? ProductRequestFollowUpDetailReportDto { get; set; }
	}

    public class ProductRequestFollowUpReportDto
    {
        ...
        public string? ProductRequestPrice { get; set; }
    ...
    public class ProductRequestFollowUpDetailReportDto
    {
		public int ProductRequestHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
		...
		public decimal ProductRequestPriceQuantity { get; set; }
		public string? ProductRequestPriceDocumentFullCodes { get; set; }
