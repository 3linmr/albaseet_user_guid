...
{
	public class StockOutReturnFromSalesInvoiceFollowUpReportVm
	{
		public StockOutReturnFromSalesInvoiceFollowUpReportDto? StockOutReturnFromSalesInvoiceFollowUpReportDto { get; set; }
		public StockOutReturnFromSalesInvoiceFollowUpDetailReportDto? StockOutReturnFromSalesInvoiceFollowUpDetailReportDto { get; set; }
	}

    public class StockOutReturnFromSalesInvoiceFollowUpReportDto
    {
    ...
    public class StockOutReturnFromSalesInvoiceFollowUpDetailReportDto
    {
		public int StockOutReturnHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
