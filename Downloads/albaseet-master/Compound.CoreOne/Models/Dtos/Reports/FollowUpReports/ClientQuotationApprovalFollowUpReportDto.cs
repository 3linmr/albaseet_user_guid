...
{
	public class ClientQuotationApprovalFollowUpReportVm
	{
		public ClientQuotationApprovalFollowUpReportDto? ClientQuotationApprovalFollowUpReportDto { get; set; }
		public ClientQuotationApprovalFollowUpDetailReportDto? ClientQuotationApprovalFollowUpDetailReportDto { get; set; }
	}

    public class ClientQuotationApprovalFollowUpReportDto
    {
    ...
    public class ClientQuotationApprovalFollowUpDetailReportDto
    {
		public int ClientQuotationApprovalHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
