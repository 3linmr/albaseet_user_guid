...
{
	public class ProformaInvoiceFollowUpReportVm
	{
		public ProformaInvoiceFollowUpReportDto? ProformaInvoiceFollowUpReportDto { get; set; }
		public ProformaInvoiceFollowUpDetailReportDto? ProformaInvoiceFollowUpDetailReportDto { get; set; }
	}

    public class ProformaInvoiceFollowUpReportDto
    {
    ...
    public class ProformaInvoiceFollowUpDetailReportDto
    {
		public int ProformaInvoiceHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
