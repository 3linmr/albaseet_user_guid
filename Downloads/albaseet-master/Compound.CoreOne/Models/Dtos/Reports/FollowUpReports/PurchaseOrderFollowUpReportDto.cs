...
{
	public class PurchaseOrderFollowUpReportVm
	{
		public PurchaseOrderFollowUpReportDto? PurchaseOrderFollowUpReportDto { get; set; }
		public PurchaseOrderFollowUpDetailReportDto? PurchaseOrderFollowUpDetailReportDto { get; set; }
	}

    public class PurchaseOrderFollowUpReportDto
    {
    ...
    public class PurchaseOrderFollowUpDetailReportDto
    {
		public int PurchaseOrderHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
