...
{
	public class SupplierQuotationFollowUpReportVm
	{
		public SupplierQuotationFollowUpReportDto? SupplierQuotationFollowUpReportDto { get; set; }
		public SupplierQuotationFollowUpDetailReportDto? SupplierQuotationFollowUpDetailReportDto { get; set; }
	}

    public class SupplierQuotationFollowUpReportDto
    {
    ...
    public class SupplierQuotationFollowUpDetailReportDto
    {
		public int SupplierQuotationHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
