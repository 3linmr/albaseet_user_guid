...
{
	public class SalesInvoiceInterimFollowUpReportVm
	{
		public SalesInvoiceInterimFollowUpReportDto? SalesInvoiceInterimFollowUpReportDto { get; set; }
		public SalesInvoiceInterimFollowUpDetailReportDto? SalesInvoiceInterimFollowUpDetailReportDto { get; set; }
	}

    public class SalesInvoiceInterimFollowUpReportDto
    {
    ...
    public class SalesInvoiceInterimFollowUpDetailReportDto
    {
		public int SalesInvoiceHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
