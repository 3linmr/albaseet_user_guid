...
{
	public class StockInFromPurchaseOrderFollowUpReportVm
	{
		public StockInFromPurchaseOrderFollowUpReportDto? StockInFromPurchaseOrderFollowUpReportDto { get; set; }
		public StockInFromPurchaseOrderFollowUpDetailReportDto? StockInFromPurchaseOrderFollowUpDetailReportDto { get; set; }
	}

    public class StockInFromPurchaseOrderFollowUpReportDto
    {
    ...
    public class StockInFromPurchaseOrderFollowUpDetailReportDto
    {
		public int StockInHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
