...
{
	public class PurchaseInvoiceInterimFollowUpReportVm
	{
		public PurchaseInvoiceInterimFollowUpReportDto? PurchaseInvoiceInterimFollowUpReportDto { get; set; }
		public PurchaseInvoiceInterimFollowUpDetailReportDto? PurchaseInvoiceInterimFollowUpDetailReportDto { get; set; }
	}

    public class PurchaseInvoiceInterimFollowUpReportDto
    {
    ...
    public class PurchaseInvoiceInterimFollowUpDetailReportDto
    {
		public int PurchaseInvoiceHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
