...
{
	public class StockInReturnFromStockInFollowUpReportVm
	{
		public StockInReturnFromStockInFollowUpReportDto? StockInReturnFromStockInFollowUpReportDto { get; set; }
		public StockInReturnFromStockInFollowUpDetailReportDto? StockInReturnFromStockInFollowUpDetailReportDto { get; set; }
	}

    public class StockInReturnFromStockInFollowUpReportDto
    {
    ...
    public class StockInReturnFromStockInFollowUpDetailReportDto
    {
		public int StockInReturnHeaderId { get; set; }
		public short MenuCode { get; set; }
		public string? MenuName { get; set; }
