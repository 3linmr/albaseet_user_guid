...
{
    public class LowProfitSalesInvoicesReportDto
    {
        ...
        public decimal InvoiceValueBeforeTax { get; set; }
        public decimal TaxValue { get; set; }//مبلغ الضريبة
        public decimal InvoiceValueAfterTax { get; set; }//المبلغ بعد الضريبة
